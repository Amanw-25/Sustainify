...
const chatWithMistralAI = async (req, res) => {
  try {
    ...
    Analyze the following carbon footprint data and provide a comprehensive and insightful response, including actionable recommendations, comparisons, and practical tips. Specifically:
    ...
    5. Comparison with Benchmarks: Compare the user's consumption levels with standard benchmarks for an average individual in a developed countr, highlighting areas where they excel and where improvements are needed. Provide statistics for context.
